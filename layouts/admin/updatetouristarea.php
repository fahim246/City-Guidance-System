...
include_once('../connection.php');
   ...
   if(isset($_GET['type']) && $_GET['type']!=''){
    $type=$_GET['type'];
     if($type=='delete'){
         $id=$_GET['id'];
         $delete_sql="delete from touristspot where place_id ='$id'";
         mysqli_query($con,$delete_sql);
     }
 }
 
         $sql="Select * from touristspot order by place_name asc";
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>UPDATE TOURIST AREA</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                                <li class="breadcrumb-item active">Update Tourist Area </li>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="box-link"><a href="addtourist_area.php">ADD Toursit Area</a> </h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
						 ...
						 <tbody>
							...
							<tr>
							   ...
							   <td>
								...
								echo "<span class='badge badge-delete'><a href='?type=delete&id=".$row['place_id']."'>Delete</a></span>";
