...
<body class="hold-transition sidebar-mini layout-fixed">
   ...
   <div id="content-wrap">
   	...
   	<div class="row">
   		...
   		<div id="main" class="five columns">
    ...
    while($row=mysqli_fetch_assoc($res)){
     ...
     <p>
        ...
        <!-- In <a href='category.php?id=<?php echo $row['category_id']; ?>' ><?php echo $row['name']; ?></a> -->
     </p>
     <div><?php echo nl2br($row['contents']); ?></div>
     <menu>
        <ul>
            <li><a href='delete_post.php?id=<?php echo $row['post_id']; ?>' onclick='return confirm_delete()'><font color="red">Delete This Post</font></a>&nbsp;||</li>
            <li><a href='edit_post.php?id=<?php echo $row['post_id']; ?>' ><font color="blue">Edit This Post</font></a></li>
        </ul>
     </menu>
						</div> 
