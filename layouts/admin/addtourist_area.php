...
if (isset($_POST['submit'])) {
    ...
    $mapurl = $_POST['map'];
    $place_desription = $_POST['description'];


    $sql = "SELECT *  FROM touristspot WHERE place_name= '$place_name'";
    $result = mysqli_query($con, $sql);
    $num = mysqli_num_rows($result);
    if ($num == 0) {
        $sql = "INSERT INTO touristspot (Division,District,place_name,place_address,place_type,place_mapurl,place_img,place_desription) VALUE ('$div','$dis','$place_name','$place_Address','$place_type','$mapurl','$image','$place_desription')";
        ...
        if ($con->query($sql)) {
            ...
            move_uploaded_file($dir, "../user//touristspot/$image");
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Add New Tourist Spot</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">NEW TOURIST SPOT</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                ...
                                <form id="validate_form" class="p-8 php-email-form" method="POST"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6 form-group">
                                            <select class="form-control" name="div" id="dis" required=""
                                        ...
                                        <div class="col-md-6 form-group">
                                            <select class="form-control" onchange=chngs() name="dis" id="dis"
                                                required="" data-parsley-trigger="keyup">
                                                <option selected Value="">Please select District</option>
                                                <?php

                                                $sql = "select distinct District from citys";
                                                $result = mysqli_query($con, $sql);
                                                while ($row = mysqli_fetch_array($result)) {
                                        ...
                                        <div class="col-md-6 form-group">
                                            <select class="form-control" required="" name="place_type" id="place_type"
                                                data-parsley-message="Please select institution type">
                                                <option selected Value="">Please select Place type</option>
                                                <?php

                                                $sql = "SELECT distinct place_type FROM touristspot";
                                                $result = mysqli_query($con, $sql);
                                                while ($row = mysqli_fetch_array($result)) {
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input type="text" class="form-control" id="institution_name"
                                                name="place_name" data-parsley-trigger="keyup" required
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input type="text" class="form-control" id="place_Address"
                                                name="place_Address" data-parsley-trigger="keyup" required
                                                placeholder="Add place Address" />
                                            <div class="validate"></div>
                                        ...
                                        <div class="col-md-6 form-group">
                                            <div class="section-title mt-2 mb-3">
                                                <h2>Please select a tourist spot image</h2>
                                            </div>
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input type="text" class="form-control" id="map" name="map"
                                                data-parsley-type="url" data-parsley-trigger="keyup" required
                                                placeholder="http://" />
                                            <div class="validate"></div>
                                        </div>
                                        ...
                                        <div class="text-center col-md-12"><input type="submit" id="submit"
